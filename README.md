...
- **Retirement countdown.** The Dashboard shows the time to financial independence as years and days. The target is 25 times the yearly expenses. The app calculates the date one time each month, at the month close, thus the count goes down each day.
