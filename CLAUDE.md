...
| `Index.html`·`Stylesheet.html`·`App.html` | The responsive SPA: HTML shell · mobile-first CSS (bottom-nav on phone, sidebar ≥860px) · vanilla-JS app. Calls the service layer **directly via `google.script.run`** (no fetch URL/token; executes as owner). Screens: Dashboard/Transactions/Accounts/Budgets/Investments/Tax. |
