...
- **Add bar**: one field for "add, search or jump". On iPhone it is docked above the tab bar with a mic and a + (the full form). On iPad and PC it sits in the header with a ⌘K / Ctrl K hint.
